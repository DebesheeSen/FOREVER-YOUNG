        ...
        <div className="mb-8 max-w-md mx-auto relative">
          <div className="relative">
            <Input
              ...
              className="pl-10 pr-4 py-2 w-full rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700"
            />
        ...
        {filteredServices.length > 0 ? (
          ...
          <div className="text-center py-12">
            <p className="text-gray-600 dark:text-gray-400 text-xl">
              No services found matching your search. Try a different term.
            </p>
          </div>
        )}
      </div>
